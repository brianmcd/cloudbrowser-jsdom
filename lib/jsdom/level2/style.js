...
/* cloudbrowser note: cssstyle is a fork of cssom with additional functionality
 * It does not work in CloudBrowser due to some assumptions made
 * advice.coffee see code there.
 */
...
html.HTMLElement.prototype.__defineGetter__('style', function() {
  ...
  if (!style) {
    ...
    style.removeAttribute = style.removeProperty;
    style.setAttribute = style.setProperty;
